...
import { Send, Headphones, Instagram, Youtube, Facebook, ExternalLink } from "lucide-react";

export function Footer() {
  return (
    <footer className="bg-[#050505] pt-20 pb-10 px-4 border-t border-brand-border text-text-main">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          {/* Services */}
          <div>
            <h3 className="font-heading font-bold text-lg mb-6 text-text-main">Services</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading font-bold text-lg mb-6 text-text-main">Quick Links</h3>
            <ul className="space-y-3 text-text-muted text-sm">
          ...
          {/* Legal & Contact */}
          <div>
            <h3 className="font-heading font-bold text-lg mb-6 text-text-main">Legal</h3>
            <ul className="space-y-3 text-text-muted text-sm mb-8">
            ...
            <h3 className="font-heading font-bold text-lg mb-4 text-text-main">Contact</h3>
            <ul className="space-y-3 text-text-muted text-sm">
